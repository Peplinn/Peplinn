...
Before you customize it, you should check [`site.config.ts`](/vault/setup/configuration#theme-configuration) to make sure there is no option that satisfy your need.
...
<Aside type='tip'>
For bun user, please refer to [Deployment#Package Mode](/vault/setup/deployment#package-mode)
