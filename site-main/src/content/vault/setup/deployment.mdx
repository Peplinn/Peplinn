...
For ones deploying on GitHub Pages with a base path, like `username.github.io/repo-name`, please read [Deployment#Platform with Base Path](/vault/setup/deployment#platform-with-base-path).
carefully.
